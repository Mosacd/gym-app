...
export const heroSectionClass = cva('relative bg-black text-white h-[90vh] flex items-center');
...
export const ghostButtonClass = cva('px-8 py-6 border font-bold hover:bg-white dark:border-neutral-800 hover:text-black');