    ...
    <header className={headerClass()}>
      <div className={containerClass()}>
        ...
        <div className={rightSectionClass()}>
          ...
          { user ?   (<Link className='hidden md:flex' to={"/dashboard/profilePage"}><Avatar className='h-10 w-10 border-4 border-purple-900 hover:scale-110 hover:border-none transition-all' >
