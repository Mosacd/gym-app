    ...
    return(
      ...
      <SheetContent side="left" className="w-full  dark:text-white">
        <SheetHeader className="mt-8">
          ...
          <Button className='bg-white border-purple-900 border-2 text-purple-900 hover:bg-slate-200 font-bold dark:bg-black dark:hover:bg-neutral-900'><svg className='fill-purple-900' width="19" height="18" viewBox="0 0 19 18" fill="none" xmlns="http://www.w3.org/2000/svg">
