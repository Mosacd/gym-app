...
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from "@/componentsShadcn/ui/card";
...
const formSchema = z.object({
  ...
  address: z
    ...
    .regex(/^[a-zA-Z\s]+\/[a-zA-Z\s]+$/, {
      message: "Location must be in the format 'Country/City' (e.g., 'USA/New York').",
    })
    .optional().or(z.literal('')),
  phone_number: z
    .string()
    .regex(/^\+?[1-9]\d{1,14}$/, {
      message: "Phone number must be a valid format, e.g., '+123456789' or '123456789'.",
    })
    .optional().or(z.literal('')),
});
...
const Account = () => {
  ...
  <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input id="Full_Name_En" placeholder={profileData.full_name_en} {...field} />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input id="Full_Name_Ka" placeholder={profileData.full_name_ka} {...field} />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input id="username" placeholder={profileData.username} {...field} />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input id="phone_number" placeholder={profileData.phone_number} {...field} />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input id="address" placeholder={profileData.address} {...field} />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input id="avatar_url" placeholder={profileData.avatar_url} {...field} />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
    ...
    <Button type="submit" className="max-w-sm m-auto sm:m-0 w-full sm:max-w-40">Update Profile</Button>
  </form>
