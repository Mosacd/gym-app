...
import { Dialog, DialogContent, DialogDescription, DialogHeader, DialogTitle, DialogTrigger } from "@/componentsShadcn/ui/dialog";
import { Button } from "@/componentsShadcn/ui/button";
import { Textarea } from "@/componentsShadcn/ui/textarea";
  ...
  return (
    <div className="max-w-screen-lg w-full">
          ...
          <DialogTrigger>
              ...
              >
                ...
                <div className="space-y-2">
                  ...
                  <img src={reviews[row.index].profiles.avatar_url?.toString()} alt="" className="w-10 h-10 rounded-md" />
          ...
          <DialogContent className="rounded-2xl max-w-screen-lg border-2 border-purple-900 dark:border-purple-900">
            <DialogHeader>
              <DialogTitle className="text-3xl dark:text-neutral-400 text-center">
                ...
                <img src={reviews[row.index].profiles.avatar_url?.toString()} alt="" className="w-10 h-10 rounded-md" />
                    <span>{reviews[row.index].profiles.username}'s Review</span>
                </div>
                <span className="text-sm text-gray-500">
                      {formatTimestamp(reviews[row.index].created_at)}
                    </span>
              ...
              <DialogDescription className="w-full">
                <div className="w-full text-lg text-center mt-10 text-black dark:text-gray-400">
                  <span>{reviews[row.index].comment} The [Product Name] exceeded my expectations with its sleek design and reliable performance. It's user-friendly, durable, and offers great value for the price. The battery life is impressive, and the features are well thought out, making it a great choice for both beginners and experienced users. However, it could benefit from a slightly faster response time. Overall, a solid purchase!</span>
            ...
            <div className="text-base font-semibold text-gray-600">{reviews[row.index].like}50 people found this review helpful</div>
</div>
            <div className="flex flex-col items-center gap-2">
              <span className="text-base font-semibold text-gray-600">did you find this helpful?</span>
              <div className="flex gap-5">
            <Button className="flex items-center">
             <span>Yes</span>
              <svg className="fill-white" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M1.24264 8.24264L8 15L14.7574 8.24264C15.553 7.44699 16 6.36786 16 5.24264V5.05234C16 2.8143 14.1857 1 11.9477 1C10.7166 1 9.55233 1.55959 8.78331 2.52086L8 3.5L7.21669 2.52086C6.44767 1.55959 5.28338 1 4.05234 1C1.8143 1 0 2.8143 0 5.05234V5.24264C0 6.36786 0.44699 7.44699 1.24264 8.24264Z" fill=""></path> </g></svg>
                      ...
                      <span>No</span>
                      <svg className="fill-purple-900" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M8 15L1.24264 8.24264C0.44699 7.44699 0 6.36786 0 5.24264V5.05234C0 2.8143 1.8143 1 4.05234 1C5.14512 1 6.1853 1.44095 6.94309 2.2124L5.85583 6.2701L7.7832 8.19746L7.10553 9.55279L8.89438 10.4472L10.2167 7.80255L8.14408 5.72991L9.74447 1.65122C10.3932 1.23104 11.1567 1 11.9477 1C14.1857 1 16 2.8143 16 5.05234V5.24264C16 6.36786 15.553 7.44699 14.7574 8.24264L8 15Z" fill=""></path> </g></svg>
      ...
      <DialogContent className="rounded-2xl max-w-screen-lg border-2 border-purple-900 dark:border-purple-900">
        ...
        <Button className="mt-5 w-full max-w-md p-5 mb-5" onClick={handleSubmit}>
         Add Your Review
        </Button>
        </div> 
        </div>
