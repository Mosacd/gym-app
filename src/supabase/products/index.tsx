...
export const getProductList = async () => {
 ...
 export type Product = {
  ...
  export const getProductListWithCategory = async (productType:string | undefined) => {
    const { data, error } = await supabase.from("product").select("*").ilike("category", productType || ""); // Replace "*" with specific columns if needed
    console.log(data);
